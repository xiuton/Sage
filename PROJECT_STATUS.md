...
- Tokenizer 升级（BPE/SentencePiece）
- GPU 后端稳定训练/推理（WGPU）
- 多档模型配置（~1M/~10M/~30M）
...
1. P0-Stop sequences
2. P0-Loss mask（ignore_index 或显式 mask）
3. P0-流式读取 JSONL（大规模数据）
4. P1-恢复 optimizer 状态
5. P2-Tokenizer 升级（BPE/SentencePiece）
6. P2-GPU 稳定训练/推理
